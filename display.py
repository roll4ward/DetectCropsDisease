from classify.pipeline import input_image, extract_to_tensor
...
if __name__ == "__main__":
    ...
    classify__models={
        "fruit": "../datasets/mangofruitdds/SenMangoFruitDDS_original/fruit_disease.pt",
        "leaf": "../datasets/mangofruitdds/SenMangoFruitDDS_original/leaf_disease.pt"
    }
